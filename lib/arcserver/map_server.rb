...
module ArcServer
  class MapServer
    ...
    def_delegators :soap_service, :get_default_map_name, :get_legend_info, :get_parcel_map,:get_extent_for_parcel,:expand_extent
    
    attr_reader    :rest_service
    def_delegators :rest_service, :export, :query
